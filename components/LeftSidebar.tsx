...
const LeftSidebar = () => {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/keithjackson1031',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/keith-jackson-b7958841/',
      icon: (
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full px-20 py-20">
          <div>
            {/* Name */}
            <h1 className="text-xl font-bold tracking-tight text-slate-200 sm:text-5xl">Keith Jackson</h1>
